...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/get-docker-secret-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7887&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/get-docker-secret-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `get-docker-secret` can be installed with:

```
conda install get-docker-secret
```

It is possible to list all of the versions of `get-docker-secret` available on your platform with:
